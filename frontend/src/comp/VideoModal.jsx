    ...
    >
      ...
      >
        ...
        <button
          ref={closeButtonRef}
          onClick={onClose}
          className="absolute top-0 right-0 bg-white rounded-full p-1 shadow hover:bg-gray-100 transition z-10 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
